...
<body data-usethemedjs="true" class="no-js {if $ADMIN || $INSTITUTIONALADMIN || $STAFF || $INSTITUTIONALSTAFF}admin{/if} {if $loggedout}loggedout{/if} {if $pagename}{$pagename}{/if}">
    ...
    <div id="top">
        <div id="logo"><img alt="banner" src="{theme_url filename='images/banner.png'}"></div>
        <div id="connect"><img style="margin-bottom: 15px;" alt="Logo" src="{theme_url filename='images/logo.png'}"></div>
    </div>
            ...
            <div id="logo-area" class="logo-area">
                ...
                {if $ADMIN || $INSTITUTIONALADMIN || $STAFF || $INSTITUTIONALSTAFF}
                    <div class="admin-title">
                        <a href="{$WWWROOT}admin/" accesskey="a" class="admin-site">Mahara {str tag="administration"}</a>
                    </div>
                {else}
                <a href="{$WWWROOT}" class="logo">Mahara 
